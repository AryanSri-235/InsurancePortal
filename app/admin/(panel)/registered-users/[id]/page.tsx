    ...
    <div className="space-y-5 max-w-4xl">
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          ...
          {dueDates.length === 0 ? (
            <div className="py-14 flex flex-col items-center text-gray-400">
              <svg className="w-8 h-8 mb-2 opacity-30" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
      ...
      {tab === "leads" && (
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          ...
          {leads.length === 0 ? (
            <div className="py-14 flex flex-col items-center text-gray-400">
              <svg className="w-8 h-8 mb-2 opacity-30" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
