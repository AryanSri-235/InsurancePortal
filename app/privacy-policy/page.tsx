...
const sections: { icon: LucideIcon; title: string; body: string }[] = [
  ...
  { icon: Lock, title: "Data Security", body: "We implement secure data centres and strict access controls to protect your personal information. While no system is 100% secure, we take all reasonable steps to protect your data from unauthorised access or disclosure." },
