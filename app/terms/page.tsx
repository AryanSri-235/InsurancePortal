...
import { FileText, Search, User, BadgeCheck, Shield, CircleDollarSign, Scale, Landmark, Phone, Copyright } from "lucide-react";
...
const sections: { icon: LucideIcon; title: string; body: string }[] = [
  { icon: FileText, title: "Acceptance of Terms", body: "By accessing or using InsurancePortal, you agree to be bound by these Terms of Service. If you do not agree, please do not use our services. We reserve the right to update these terms at any time; continued use after changes constitutes acceptance." },
  { icon: Search, title: "Nature of Services", body: "InsurancePortal is an IRDAI-registered web aggregator (Reg. No. WBA000000). We provide insurance comparison and lead-referral services. We are not an insurer. Policies are issued directly by the respective insurance companies." },
  { icon: User, title: "Eligibility", body: "You must be at least 18 years of age and a resident of India to use our services. By using the platform, you confirm that the information you provide is accurate and truthful." },
  { icon: BadgeCheck, title: "User Obligations", body: "You agree to: provide accurate and complete information; not use the platform for any unlawful purpose; not attempt to hack, scrape, or disrupt our services; not impersonate any person or entity; and comply with all applicable Indian laws." },
  { icon: Shield, title: "Insurance Transactions", body: "InsurancePortal facilitates connections between users and insurers. The insurance contract is solely between you and the insurer. We are not liable for any acts, omissions, or decisions made by insurance companies, including claim decisions." },
  { icon: CircleDollarSign, title: "Commission Disclosure", body: "As a web aggregator, we receive commission from insurers for referrals. This commission does not affect the premium you pay — it is borne by the insurer. We are required to disclose this under IRDAI regulations." },
