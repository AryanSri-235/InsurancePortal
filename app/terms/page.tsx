...
const sections: { icon: LucideIcon; title: string; body: string }[] = [
  ...
  { icon: Search, title: "Nature of Services", body: "InsurancePortal is an IRDAI-registered web aggregator (Reg. No. 0006012K). We provide insurance comparison and lead-referral services. We are not an insurer. Policies are issued directly by the respective insurance companies." },
