...
const sections: { icon: LucideIcon; title: string; body: string }[] = [
  { icon: Landmark, title: "IRDAI Registration", body: "InsurancePortal is registered with the Insurance Regulatory and Development Authority of India (IRDAI) as a Web Aggregator under License No. 0006012K. Our registration authorises us to facilitate the solicitation and purchase of insurance products from IRDAI-registered insurers." },
