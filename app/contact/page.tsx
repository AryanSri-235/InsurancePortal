...
const channels: { icon: LucideIcon; title: string; detail: string; sub: string; color: string; iconBg: string; from: string; to: string }[] = [
  { icon: Phone, title: "Call Us", detail: "+91 80761 75709", sub: "24×7", color: "border-blue-200 hover:border-blue-300 hover:shadow-blue-100/80", iconBg: "bg-blue-50", from: "#3b82f6", to: "#6366f1" },
