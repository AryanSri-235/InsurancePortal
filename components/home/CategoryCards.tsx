...
const categories: Category[] = [
  ...
  { href: "/motor-insurance",         icon: Car,         title: "Motor Insurance",         subtitle: "All vehicles covered",      description: "Compare comprehensive & third-party plans for cars, bikes & commercial vehicles. Cashless garages nationwide.",      badge: "Car + Bike Plans",   stat: "Cashless garages",    accent: "blue"  },
...
const A = {
  ...
  green: {
    ...
    glow:    "hover:shadow-indigo-100/60",
    iconBg:  "bg-white border border-gray-200",
    iconFg:  "text-gray-900",
  },
};
