...
const configs: Record<Variant, IconPlacement[]> = {
  hero: [
    ...
    { Icon: RingDecor,   color: "text-blue-300", size: "w-64 h-64", pos: "-bottom-16 -right-16",   anim: "animate-spin-slow",     delay: "delay-500" },
  ],
  categories: [
    { Icon: Shield,      color: "text-blue-400",   size: "w-20 h-20", pos: "top-6 left-[2%]",       anim: "animate-float",         delay: "delay-100" },
    { Icon: Coin,        color: "text-blue-300",  size: "w-16 h-16", pos: "top-10 right-[4%]",     anim: "animate-float-reverse", delay: "delay-400" },
  ...
  howItWorks: [
    { Icon: Document,    color: "text-blue-300", size: "w-18 h-20", pos: "top-10 left-[4%]",      anim: "animate-float-drift",   delay: "delay-100" },
    { Icon: Stethoscope, color: "text-emerald-400",size: "w-20 h-20", pos: "top-14 right-[6%]",     anim: "animate-float-slow",    delay: "delay-400" },
    { Icon: RingDecor,   color: "text-blue-200",  size: "w-44 h-44", pos: "bottom-4 left-[30%]",   anim: "animate-spin-slow",     delay: "delay-0" },
  ],
  calculator: [
    { Icon: Coin,        color: "text-blue-300",  size: "w-20 h-20", pos: "top-8 left-[5%]",       anim: "animate-float-slow",    delay: "delay-200" },
  ...
  faq: [
    ...
    { Icon: Document,    color: "text-indigo-300", size: "w-14 h-18", pos: "bottom-12 left-[4%]",   anim: "animate-float-reverse", delay: "delay-0" },
